...
('claude-social-thread', 'Official Claude social thread', 'https://x.com/claudeai/status/2065456678909227064', 'Official community showcase thread. Some individual media links need manual confirmation because public scraping exposes limited content.', 4),
...
('claude-social-thread', 'zh', 'Claude 官方社交线程', '官方社区展示线程；部分媒体内容仍需要人工复核。'),
...
('soccer-neo-gothic-plane', 'Soccer game, neo-gothic city, and plane model set', 'Instagram community post', 'Demo', 'A social post describes a set of projects built with Claude Fable 5, including a soccer game, neo-gothic city, and plane model.', 'A bundle entry awaiting direct media review; useful as an intake target because it names multiple visual projects.', 'https://www.instagram.com/p/DZfmFqJIK8Y/', NULL, '2026-06-13', 'needs-review', 'Three-item social media showcase', 1, 14, 'published');
