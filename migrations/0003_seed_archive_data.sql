...
INSERT OR REPLACE INTO archive_projects (id, name, author, project_type, usage, summary, source_url, project_url, published_date, evidence, image_hint, sort_order, status) VALUES
('solar-system-physics', 'Physics-first solar system simulator', 'Anthropic demo', 'Demo', 'Built by Fable 5 as an autonomous simulation, deriving orbital motion from first principles and using it to predict eclipses.', 'A browser-style scientific simulation used in Anthropic''s launch material to illustrate long-horizon reasoning and implementation.', 'https://www.anthropic.com/news/claude-fable-5-mythos-5', NULL, '2026-06-09', 'primary', 'Orbit traces and eclipse prediction', 1, 'approved'),
('factorio-agent', 'Autonomous Factorio factory', 'Anthropic demo', 'Game', 'Fable 5 played Factorio, strategized, and built an automated factory on its own.', 'A game-playing demonstration that positioned Fable 5 as a model capable of sustained planning in dynamic environments.', 'https://www.anthropic.com/news/claude-fable-5-mythos-5', NULL, '2026-06-09', 'primary', 'Factory belts and autonomous build planning', 2, 'approved'),
('browser-cad-copilot', 'Browser CAD editor and 3D printable model', 'Anthropic demo', 'Tool', 'Fable 5 created a browser CAD editor, its AI copilot, and a complete 3D-printable model inside it.', 'A nested creation example: a tool made by Fable 5 was then used by Fable 5 to produce a physical-design artifact.', 'https://www.anthropic.com/news/claude-fable-5-mythos-5', NULL, '2026-06-09', 'primary', 'Parametric model in a browser CAD surface', 3, 'approved'),
...
('soccer-neo-gothic-plane', 'Soccer game, neo-gothic city, and plane model set', 'Instagram community post', 'Demo', 'A social post describes a set of projects built with Claude Fable 5, including a soccer game, neo-gothic city, and plane model.', 'A social media bundle entry preserved because it names multiple visual projects.', 'https://www.instagram.com/p/DZfmFqJIK8Y/', NULL, '2026-06-13', 'community', 'Three-item social media showcase', 14, 'approved');
